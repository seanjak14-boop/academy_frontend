...
export function SignupForm() {
  const { signupWithPassword, user, isReady } = useAuth();
      ...
      <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-4 py-16 sm:px-6">
        ...
        <div className="rounded-2xl border-2 border-emerald-100/80 bg-white/95 p-8 shadow-2xl shadow-emerald-600/15 ring-2 ring-teal-200/40 backdrop-blur-sm dark:border-zinc-800 dark:bg-zinc-900/85 dark:shadow-black/40 dark:ring-white/10">
          ...
          <p className="mt-2 text-center text-sm text-zinc-500 dark:text-zinc-400">
            Join XYZ Academy — you&apos;ll see announcements and fixtures as a player.
          </p>

          <form onSubmit={onSubmit} className="mt-8 space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="sm:col-span-1">
                <label htmlFor="su-fn" className="mb-1.5 block text-xs font-semibold uppercase tracking-wide text-zinc-500">
                  First name
                </label>
                <input
                  id="su-fn"
                  ...
                  className="w-full rounded-xl border border-zinc-200 bg-zinc-50 px-4 py-3 text-sm outline-none focus:border-emerald-500/60 focus:ring-2 focus:ring-emerald-500/25 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100"
                />
              </div>
              <div className="sm:col-span-1">
                <label htmlFor="su-ln" className="mb-1.5 block text-xs font-semibold uppercase tracking-wide text-zinc-500">
                  Last name
                </label>
                <input
                  id="su-ln"
            ...
            <div>
              <label htmlFor="su-email" className="mb-1.5 block text-xs font-semibold uppercase tracking-wide text-zinc-500">
                Email address
              </label>
              <input
                id="su-email"
            ...
            <div>
              <label htmlFor="su-phone" className="mb-1.5 block text-xs font-semibold uppercase tracking-wide text-zinc-500">
                Phone number
              </label>
              <input
                id="su-phone"
            ...
            <div>
              <label htmlFor="su-pass" className="mb-1.5 block text-xs font-semibold uppercase tracking-wide text-zinc-500">
                Password
              </label>
              <input
                id="su-pass"
            ...
            <button
              type="submit"
              className="w-full rounded-xl bg-emerald-600 py-3 text-sm font-semibold text-white shadow-lg shadow-emerald-900/20 transition hover:bg-emerald-500"
            >
              Sign up
            </button>
          </form>

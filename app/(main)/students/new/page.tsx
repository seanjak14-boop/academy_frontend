...
export default function NewStudentsPage() {
  ...
  const tierPlayers = students.filter((s) => s.tier === "new");
  const { title, description } = rosterTitleCopy("new");
    ...
    <>
      ...
      <div className="mb-10 max-w-xl">
        <StatCard
          ...
          accent
          hint="Roster below is sorted by join date (newest mock data first)."
        />
      </div>
      <StudentRoster
